...
## Directories
testDir <- "/Users/Moe/Documents/workspace/HarvardForest/RDataTracker/examples-no-instrumentation/AaronSimesDendrochronology/"
setwd(testDir)
...
# Run the script
#ddg.run("AaronSimesDendrochronology.R", "/Users/Moe/Documents/workspace/HarvardForest/RDataTracker/examples-no-instrumentation/AaronSimesDendrochronology/ddg", ignore.ddg.calls = F)
ddg.run("AaronSimesDendrochronology.R", "/Users/Moe/Documents/workspace/HarvardForest/RDataTracker/examples-no-instrumentation/AaronSimesDendrochronology/ddg")
